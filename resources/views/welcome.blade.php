        ...
        <div class="title">Bruce</div>
            ...
            <select class="form-control pull-right" name="voice" style="margin-top:10px;">
                <option>Alex</option>
                 ...
                 <option>Maged</option>
                 <option>Tarik</option>
                 <option>Ting-Ting</option>
                 <option>Sin-ji</option>
                 <option>Mei-Jia</option>
                 <option>Iveta</option>
                 ...
                 <option>Nikos</option>
                 <option>Carmit</option>
                 <option>Lekha</option>
                 <option>Mariska</option>
                 <option>Damayanti</option>
                 <option>Alice</option>
                 <option>Fredrica</option>
                 <option>Luca</option>
                 <option>Kyoko</option>
                 <option>Otoya</option>
                 <option>Yuna</option>
